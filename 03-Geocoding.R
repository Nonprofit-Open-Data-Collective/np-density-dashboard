...
wd<-('/Volumes/My Passport for Mac/Urban Institute/Summer Projects/Geospatial Dashboard/R code for now/Data-Wrangled')
setwd( wd )
...
#setting wd 
wd2 <- '/Volumes/My Passport for Mac/Urban Institute/Summer Projects/Geospatial Dashboard/R code for now/addresses_npo'
setwd(wd2)
...
for (i in 291:loops){
  ...
  print( end_time - start_time ) # print system time to keep track of progress of loop
}

#### Now repeat the same for the people's database

# read in ppl data
setwd(wd)
ppl <- readRDS( "pplAddresses_census.rds" )

#dir.create( "/Volumes/My Passport for Mac/Urban Institute/Summer Projects/Geospatial Dashboard/R code for now/addresses_ppl" )

### Split into batches of 500 

#setting wd 
wd2 <- '/Volumes/My Passport for Mac/Urban Institute/Summer Projects/Geospatial Dashboard/R code for now/addresses_ppl'
setwd(wd2)
